...
export const Puma = (props: { itemsArr: SnikersItem[] }) => {
    return (
        <div>
            <h2>PUMA</h2>
            ...
            <S.ImgWrapper>
                {props.itemsArr.map(el => {
                    return (
                        <Link key={el.id} to={`${PATH.PAGE2}/${el.id}`} style={{ textDecoration: 'none' }}>
            ...
            <p>
                What is Lorem Ipsum?
                Lorem Ipsum is simply ummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard
